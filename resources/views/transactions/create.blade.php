...
<div class="card">
    <div class="card-body text-center py-5" style="background:#0e1117;">
        ...
        <a href="{{ route('bundle.create') }}" class="btn btn-sm mt-3 px-4" style="background:#1f6feb; color:#fff; border:none; border-radius:6px; font-size:.82rem;">
                ...
                <div class="mb-4">
                    ...
                    <select name="bundle_id" id="bundleSelect" class="form-select form-select-sm"
                        ...
                        <option value="{{ $bundle->id }}"
                            data-items="{{ $bundle->items->map(fn($i) => ($i->asset->nama_perangkat ?? '?') . ' (' . ($i->asset->serial_number ?? '-') . ')')->join(', ') }}"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4">
                                ...
                                <div style="color:#484f58; font-size:.72rem;">{{ $rt->tanggal_serah->format('d/m/Y') }}</div>
                            </td>

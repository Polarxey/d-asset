                ...
                <form action="{{ route('rma.generate.pdf', $asset->id) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="date" name="tanggal_rma" class="form-control form-control-sm" style="background:#161b22; border:1px solid #30363d; color:#c9d1d9;" value="{{ date('Y-m-d') }}" required>
                        </div>
                    </div>

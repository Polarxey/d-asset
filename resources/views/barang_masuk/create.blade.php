        ...
        <form action="{{ route('barang_masuk.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="nama_perangkat" class="form-control form-control-sm" style="background:#161b22; border:1px solid #30363d; color:#c9d1d9;" placeholder="Contoh: ONU GPON / Switch L2" required value="{{ old('nama_perangkat') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label" style="font-size:.78rem; color:#8b949e; text-transform:uppercase; letter-spacing:.5px;">Merk</label>
                    <input type="text" name="merk" class="form-control form-control-sm" style="background:#161b22; border:1px solid #30363d; color:#c9d1d9;" placeholder="Huawei / ZTE / Nokia" value="{{ old('merk') }}">
                </div>
                <div class="col-md-6">

    ...
    <div class="card-body p-4" style="background:#0e1117;">
        <form action="{{ route('barang_masuk.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <label class="form-label" style="font-size:.78rem; color:#8b949e; text-transform:uppercase; letter-spacing:.5px;">Material Number <span style="color:#f85149;">*</span></label>
                    <input type="text" name="material_number" class="form-control form-control-sm" style="background:#161b22; border:1px solid #30363d; color:#c9d1d9;" required value="{{ old('material_number') }}">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="merk" class="form-control form-control-sm" style="background:#161b22; border:1px solid #30363d; color:#c9d1d9;" value="{{ old('merk') }}">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="type" class="form-control form-control-sm" style="background:#161b22; border:1px solid #30363d; color:#c9d1d9;" required value="{{ old('type') }}">
                </div>

...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/rma', [RmaController::class, 'index'])->name('rma.index');
    Route::get('/rma/history', [RmaController::class, 'history'])->name('rma.history');
    ...
    Route::get('/rma/search-used', [RmaController::class, 'searchUsed'])->name('rma.search_used');
    Route::get('/rma/download-pdf/{id}', [RmaController::class, 'downloadPdfHistory'])->name('rma.download_pdf');

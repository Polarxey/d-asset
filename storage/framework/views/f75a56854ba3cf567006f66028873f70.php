                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center pe-4">
                                <a href="<?php echo e(route('rma.generate.form', $item->id)); ?>"
                                ...
                                <button class="btn btn-sm ms-1" style="background:#1c2128; color:#8b949e; border:1px solid #30363d; font-size:.75rem; border-radius:6px;"
                                    data-bs-toggle="modal" data-bs-target="#modalEdit<?php echo e($item->id); ?>">Edit</button>
                                <form action="<?php echo e(route('assets.destroy', $item->id)); ?>" method="POST" class="d-inline"
                                    onsubmit="return confirm('Hapus aset S/N <?php echo e($item->serial_number); ?>?')">

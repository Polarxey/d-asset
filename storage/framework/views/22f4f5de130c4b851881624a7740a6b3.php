            ...
            <div class="card-body p-4" style="background:#0e1117;">
                ...
                <div id="item-container">
                    ...
                    <div class="item-row mb-2 p-3 rounded" style="background:#161b22; border:1px solid #21262d;">
                        <div class="d-flex align-items-center gap-2">
                            <div style="flex:1;">
                                ...
                                <div style="font-size:.73rem; color:#8b949e;"><?php echo e($group->merk ?? 'No brand'); ?> &middot; Stok tersedia: <span style="color:#3fb950; font-weight:600;"><?php echo e($group->stok_tersedia); ?></span></div>
                            ...
                            <div style="width:90px;">
                                ...
                                <input type="number" name="items[<?php echo e($idx); ?>][qty]"
                                    class="form-control form-control-sm text-center"
                                    style="background:#0e1117; border:1px solid #30363d; color:#c9d1d9;"
                                    value="0" min="0" max="<?php echo e($group->stok_tersedia); ?>">
                            </div>
                            <div style="width:70px; text-align:center;">
                                <div style="font-size:.7rem; color:#8b949e; margin-bottom:2px;">Stok</div>
                                <div class="badge" style="background:#1a2a1a; color:#3fb950; font-size:.78rem;"><?php echo e($group->stok_tersedia); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center py-5" style="color:#484f58;">
                        ...
                        <a href="<?php echo e(route('barang_masuk.create')); ?>" style="color:#58a6ff; font-size:.82rem;">Tambah barang masuk baru →</a>
                    </div>
                    <?php endif; ?>
                </div>

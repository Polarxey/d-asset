...
<div class="sidebar p-3">
    ...
    <ul class="nav nav-pills flex-column mb-auto" style="gap:1px">
        ...
        <li>
            <a href="<?php echo e(route('assets.index')); ?>" class="nav-link <?php echo e(request()->routeIs('assets.index') ? 'active' : ''); ?>">
        ...
        <li>
            <a href="<?php echo e(route('barang_masuk.create')); ?>" class="nav-link <?php echo e(request()->routeIs('barang_masuk.*') ? 'active' : ''); ?>">
        ...
        <li>
            <a href="<?php echo e(route('bundle.create')); ?>" class="nav-link <?php echo e(request()->routeIs('bundle.create') ? 'active' : ''); ?>">
                <i class="ti ti-packages me-2"></i>Buat Paket Keluar
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('bundle.index')); ?>" class="nav-link <?php echo e(request()->routeIs('bundle.index') ? 'active' : ''); ?>">
        ...
        <li>
            <a href="<?php echo e(route('transactions.create')); ?>" class="nav-link <?php echo e(request()->routeIs('transactions.create') ? 'active' : ''); ?>">
        ...
        <li>
            <a href="<?php echo e(route('activity_log.index')); ?>" class="nav-link <?php echo e(request()->routeIs('activity_log.*') ? 'active' : ''); ?>">

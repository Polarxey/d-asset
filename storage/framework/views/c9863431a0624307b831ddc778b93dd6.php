...
<head>
    <meta charset="UTF-8">
    <title>RMA - <?php echo e($noRma); ?></title>
    <style>
...
<div class="page">
        ...
        <tr>
            <td style="width:50%;">
                <?php if(!empty($logoBase64)): ?>
                    <img src="<?php echo e($logoBase64); ?>" class="logo">
                <?php else: ?>
            ...
            <td>
                ...
                <div style="text-align:right; margin-top:5px;">
                    <span class="no-rma-box"><?php echo e($noRma); ?></span>
                </div>
            </td>
        </tr>
    </table>
    ...
    <div class="meta-box">
        <table>
            <tr>
                ...
                <td class="colon">:</td>
                <td class="value"><?php echo e(\Carbon\Carbon::parse($tanggalRma)->translatedFormat('d F Y')); ?></td>
                <td class="label" style="padding-left:20px;">Valuation Type</td>
                <td class="colon">:</td>
                <td><span class="valuation-badge"><?php echo e($asset->valuation_type ?? '-'); ?></span></td>
            </tr>
            <tr>
                <td class="label">ID PA</td>
                <td class="colon">:</td>
                <td class="value" style="font-family:monospace;"><?php echo e($asset->id_pa ?? '-'); ?></td>
                <td class="label" style="padding-left:20px;">Tgl Perangkat Masuk</td>
                <td class="colon">:</td>
                <td class="value"><?php echo e($asset->tanggal_masuk?->translatedFormat('d F Y') ?? '-'); ?></td>
            </tr>
        </table>
    </div>
    ...
    <table class="info-grid">
        <tr>
            ...
            <td class="colon">:</td>
            <td class="value"><?php echo e($asset->nama_perangkat); ?></td>
        </tr>
        <tr>
            <td class="label">Merk / Pabrikan</td>
            <td class="colon">:</td>
            <td class="value"><?php echo e($asset->merk ?? '-'); ?></td>
        </tr>
        <tr>
            <td class="label">Serial Number (S/N)</td>
            <td class="colon">:</td>
            <td class="value" style="font-family:monospace; color:#003366;"><?php echo e($asset->serial_number); ?></td>
        </tr>
        <tr>
            <td class="label">Lokasi Asal (Lapangan)</td>
            <td class="colon">:</td>
            <td class="value"><?php echo e($asset->lokasi_asal ?? '-'); ?></td>
        </tr>
        <tr>
            <td class="label">Customer / Site (CPE)</td>
            <td class="colon">:</td>
            <td class="value"><?php echo e($asset->customer_name ?? '-'); ?></td>
        </tr>
    </table>
    ...
    <table class="sig-table">
        <tr>
            ...
            <td>
                <div class="sig-box">
                    <div class="sig-title">Bandung, <?php echo e(\Carbon\Carbon::parse($tanggalRma)->translatedFormat('d F Y')); ?></div>
    ...
    <div class="doc-footer">
        ...
        Nomor: <?php echo e($noRma); ?> · Dicetak: <?php echo e(now()->format('d/m/Y H:i')); ?>
...
<?php /**PATH D:\WINDOWS\XAMPP\htdocs\d-asset\resources\views/pdf/rma.blade.php ENDPATH**/ ?>
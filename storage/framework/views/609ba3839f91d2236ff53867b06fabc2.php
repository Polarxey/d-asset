    ...
    <div class="login-card">
        ...
        <form action="<?php echo e(route('login.post')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control form-control-sm" required autofocus value="<?php echo e(old('email')); ?>">
            </div>
            <div class="mb-4">
...
</html><?php /**PATH D:\WINDOWS\XAMPP\htdocs\d-asset\resources\views/auth/login.blade.php ENDPATH**/ ?>
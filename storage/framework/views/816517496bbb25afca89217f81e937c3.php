    ...
    <div class="card-body p-0">
        <table class="table table-dark table-hover mb-0" style="font-size:.82rem;">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4"><code style="color:#58a6ff;"><?php echo e($t->no_bstp); ?></code></td>
                    <td><?php echo e($t->penerima); ?></td>
                    <td style="color:#8b949e;"><?php echo e($t->lokasi_tujuan); ?></td>
                    <td style="color:#8b949e;"><?php echo e($t->tanggal_serah->format('d/m/Y')); ?></td>
                    <td>
                        <span style="color:#c9d1d9; font-weight:600;"><?php echo e($t->details->count()); ?></span>
                        <span style="color:#484f58;"> jenis perangkat</span>
                    </td>
                    <td class="text-center pe-4">
                        <a href="<?php echo e(route('transactions.pdf', $t->id)); ?>"
...
<?php echo $__env->make('welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\WINDOWS\XAMPP\htdocs\d-asset\resources\views/transactions/index.blade.php ENDPATH**/ ?>
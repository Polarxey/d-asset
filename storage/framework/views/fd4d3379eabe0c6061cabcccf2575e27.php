        ...
        <form action="<?php echo e(route('barang_masuk.store')); ?>" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="material_number" class="form-control form-control-sm" style="background:#161b22; border:1px solid #30363d; color:#c9d1d9;" required value="<?php echo e(old('material_number')); ?>">
                </div>
